      ...
      <section className="relative overflow-hidden rounded-[36px] border border-[rgba(126,135,212,0.16)] bg-[linear-gradient(135deg,rgba(255,255,255,0.94),rgba(244,242,255,0.96)_48%,rgba(249,246,255,0.94)_100%)] p-10 shadow-[0_28px_70px_rgba(126,119,213,0.16)]">
        ...
        <div className="mx-auto max-w-3xl space-y-6 text-[#25306d]">
          <div className="space-y-3 text-center">
            <h1 className="text-3xl font-semibold">About FairFetch</h1>
            <p className="text-base leading-relaxed text-[#6e759b]">
              AI is becoming the web’s main reader. Today that traffic is invisible, unaccountable, and often hostile to the sites it depends on. FairFetch’s job is to build practical marketplace infrastructure for licensed research retrieval.
            </p>
          </div>
          <div className="grid gap-4 md:grid-cols-3">
            <MarketingCard className="bg-[linear-gradient(180deg,rgba(255,255,255,0.82),rgba(244,242,255,0.84))]">
              <h3 className="text-lg font-semibold text-[#25306d]">Specialist research as infrastructure</h3>
            ...
            <MarketingCard className="bg-[linear-gradient(180deg,rgba(255,255,255,0.82),rgba(247,243,255,0.84))]">
              <h3 className="text-lg font-semibold text-[#25306d]">Permissions, pricing, and logs by default</h3>
              <p className="mt-2 text-sm leading-7 text-[#6e759b]">
            ...
            <MarketingCard className="bg-[linear-gradient(180deg,rgba(255,255,255,0.82),rgba(243,246,255,0.84))]">
              <h3 className="text-lg font-semibold text-[#25306d]">MVP first, then broader coverage</h3>
              <p className="mt-2 text-sm leading-7 text-[#6e759b]">
                The MVP is a hosted service: a working marketplace prototype. The long-term goal is a standard way for any site and any AI to talk about access, no matter who runs the infra underneath.
              </p>
            </MarketingCard>
          </div>
        </div>
