        ...
        <div className="mx-auto max-w-4xl space-y-8 text-white">
          <div className="space-y-3 text-center">
            ...
            <p className="text-base leading-relaxed text-white/80">
              AI is becoming the web’s main reader. FairCrawl turns that traffic into a protocol with clear consent, speed, and value
              built in for both sides.
            </p>
          </div>
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <MarketingCard className="text-white">
              ...
              <p className="mt-2 text-sm leading-relaxed text-white/70">
                Every AI request should carry identity, pacing, and a way to account for value. FairCrawl bakes identity, rate limits,
                and metering into the request path.
              </p>
            </MarketingCard>
            <MarketingCard className="text-white">
              <h3 className="text-lg font-semibold">From one product to a standard</h3>
              <p className="mt-2 text-sm leading-relaxed text-white/70">
                The MVP is a shared gateway for AI traffic. The long-term goal is a standard way for any site and any AI to talk about
                access, no matter who runs the infra.
              </p>
            </MarketingCard>
          </div>
          <SectionActions>
