...
const publisherItems = [
  ...
  ...(process.env.NEXT_PUBLIC_DEMO_MODE === 'true' ? [{ href: '/publisher/demo', label: 'Demo Console' }] : []),
];

export default function PublisherLayout({ children }: { children: React.ReactNode }) {
  return (
    <DashboardShell>
      <DashboardHeader title="Publisher Dashboard" subtitle="Onboard domains, set pricing, and track AI usage revenue." />
